  ...
  return (
    <main className="min-h-screen bg-[#05070A] text-white font-display overflow-x-hidden selection:bg-blue-500/30">
      ...
      <section className="relative min-h-[90dvh] flex flex-col items-center justify-center pt-20 px-6">
        ...
        <nav className="absolute top-0 inset-x-0 z-50 px-8 py-6 flex justify-between items-center max-w-7xl mx-auto w-full">
          <div className="text-xl font-black tracking-tighter uppercase italic">
            Oratoria<span className="text-blue-500">PRO</span>
          </div>
          <button onClick={() => router.push("/auth/login")} className="text-[10px] font-black tracking-widest text-slate-500 hover:text-white transition-colors uppercase border border-white/10 px-4 py-2 rounded-full">
            MIEMBROS
          </button>
        </nav>

        <div className="max-w-6xl mx-auto text-center relative z-10 space-y-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-[0.3em] text-blue-400 mb-6 animate-fade-in">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase leading-tight">
              ¿Por qué algunos <br className="hidden md:block" /> <span className="text-red-500">dominan</span> y otros <br className="hidden md:block" /> pasan desapercibidos?
            </h2>
      ...
      <section className="py-40 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((b, i) => (
             <div key={i} className="group p-8 rounded-[40px] bg-white/[0.03] border border-white/10 hover:bg-white/[0.05] hover:border-white/20 transition-all duration-500 relative flex flex-col">
                <div className={`size-16 rounded-2xl bg-${b.color}-500/10 flex items-center justify-center text-${b.color}-400 mb-8 shrink-0 overflow-hidden`}>
                ...
                <p className="text-slate-400 text-sm leading-relaxed flex-grow">{b.desc}</p>
